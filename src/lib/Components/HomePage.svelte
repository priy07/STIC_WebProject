...
<main class="pt-10 h-[550px] lg:h-[700px] sm">
    <div class="HomePage align-middle text-center h-[700px] pt-32">
        ...
        <button class="border-2 border-cyan-400 rounded-lg mt-4"><h1 class="font-inter lg:text-[21px] sm:text-[15px] text-[10px] font-semibold text-base leading-7 text-center text-gray-400 hover:bg-cyan-300 hover:text-gray-700 transition-all lg:px-14 lg:py-4 md:px-10 md:py-3 sm:px-7 sm:py-2 px-5 py-1"><a href="#member">Join Us</a></h1></button>
